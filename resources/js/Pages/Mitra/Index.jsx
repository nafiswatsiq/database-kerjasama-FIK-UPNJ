                ...
                <div className="mx-auto max-w-7xl sm:px-6 lg:px-8 flex flex-col gap-y-8">
                    ...
                    <div className="grid grid-cols-4 gap-6">
                        <Link
                            ...
                            className="overflow-hidden bg-white sm:rounded-2xl shadow-lg"
                        >
                                    ...
                                    <div>
                                        <div className="bg-[#E5E4FF] p-3 rounded-3xl">
                                            ...
                                            >
                                                <path
                                                    opacity="0.4"
                                                    d="M34.9999 36.6667H4.99988C4.31654 36.6667 3.74988 36.1 3.74988 35.4167C3.74988 34.7333 4.31654 34.1667 4.99988 34.1667H34.9999C35.6832 34.1667 36.2499 34.7333 36.2499 35.4167C36.2499 36.1 35.6832 36.6667 34.9999 36.6667Z"
                                                    fill="#8280FF"
                                                />
                                                <path
                                                    opacity="0.4"
                                                    d="M31.7 5.8C28.4666 2.56667 25.3 2.48333 21.9833 5.8L19.9666 7.81667C19.8 7.98333 19.7333 8.25 19.8 8.48333C21.0666 12.9 24.6 16.4333 29.0166 17.7C29.0833 17.7167 29.15 17.7333 29.2166 17.7333C29.4 17.7333 29.5666 17.6667 29.7 17.5333L31.7 15.5167C33.35 13.8833 34.15 12.3 34.15 10.7C34.1666 9.05 33.3666 7.45 31.7 5.8Z"
                                                    fill="#8280FF"
                                                />
                                                <path
                        ...
                        >
                            <div className="p-4 text-gray-900">
                                    ...
                                    <div>
                                        <div className="bg-[#D9F7E8] p-3 rounded-3xl">
                                            ...
                                            >
                                                <path
                                                    opacity="0.4"
                                                    d="M34.1666 16.9833H29.35C25.4 16.9833 22.1833 13.7667 22.1833 9.81667V5C22.1833 4.08334 21.4333 3.33334 20.5166 3.33334H13.45C8.31663 3.33334 4.16663 6.66667 4.16663 12.6167V27.3833C4.16663 33.3333 8.31663 36.6667 13.45 36.6667H26.55C31.6833 36.6667 35.8333 33.3333 35.8333 27.3833V18.65C35.8333 17.7333 35.0833 16.9833 34.1666 16.9833Z"
                                                    fill="#4AD991"
                                                />
                                                <path
                                                    d="M26.3335 3.68333C25.6501 3 24.4668 3.46667 24.4668 4.41667V10.2333C24.4668 12.6667 26.5335 14.6833 29.0501 14.6833C30.6335 14.7 32.8335 14.7 34.7168 14.7C35.6668 14.7 36.1668 13.5833 35.5001 12.9167C33.1001 10.5 28.8001 6.15 26.3335 3.68333Z"
                                                    fill="#4AD991"
                                                />
                                                <path
                                                    d="M22.5 22.9167H12.5C11.8167 22.9167 11.25 22.35 11.25 21.6667C11.25 20.9833 11.8167 20.4167 12.5 20.4167H22.5C23.1833 20.4167 23.75 20.9833 23.75 21.6667C23.75 22.35 23.1833 22.9167 22.5 22.9167Z"
                                                    fill="#4AD991"
                                                />
                                                <path
                                                    d="M19.1667 29.5833H12.5C11.8167 29.5833 11.25 29.0167 11.25 28.3333C11.25 27.65 11.8167 27.0833 12.5 27.0833H19.1667C19.85 27.0833 20.4167 27.65 20.4167 28.3333C20.4167 29.0167 19.85 29.5833 19.1667 29.5833Z"
                                                    fill="#4AD991"
                                                />
                                            </svg>
                                        </div>
                                ...
                                <div className="mt-4">
                                    <p className="">
                                        From a total of {totalAgreement}
                                    </p>
                                </div>
                            </div>
                        </Link>
